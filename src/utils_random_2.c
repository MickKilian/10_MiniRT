...
/*   Updated: 2024/03/23 06:53:28 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3	random_in_same_hemisphere(t_vec3 normal)
{
...
t_vec3	random_in_unit_disk(void)
{
	...
	while (true)
	{
		p = new_vec3(random_double_interval(-1, 1),
				random_double_interval(-1, 1), 0);
		if (vec3_len_sq(p) < 1)
			return (p);
	}
}
